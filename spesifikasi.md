...
- **Materi Pokok**   : Perangkat Keras Komputer
- **Tujuan Belajar** : Siswa mampu mengenal perangkat keras komputer beserta fungsinya
- **Nama Guru**      : Syaiful Padmoyo Adi, S.T.
- **Nama Sekolah**   : SMP Negeri 2 Kedungpring
- **File Logo**      : logo_smp.png
- **File Foto Guru** : foto profil.jpeg
- **File Background**: ruang_kelas.jpg
